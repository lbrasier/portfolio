    ...
    stage('Build') {
      ...
      steps {
        dir(path: '../current') {
          ...
          bat(script: '"C:\Windows\Microsoft.NET\Framework64\v4.0.30319\MSBuild.exe" "..\\current\\ContactListSample\\ContactsList.API.csproj"', returnStdout: true, returnStatus: true)
		}
